...
const apprDlg = document.getElementById("appreciateDialog");
const openBtn = document.getElementById('openDialog');
const closeBtn = document.getElementById('closeDialog');
const closeBtnAppr = document.getElementById('closeDialog1');
...
closeBtnAppr.addEventListener('click', () => apprDlg?.close('success'));
...
// Пример: таргетированное сообщение
    ...
    if (phone && !isValid(phone)) {
      phone.setCustomValidity('Введите корректный номер телефона, например +7 999 999-99-99');
